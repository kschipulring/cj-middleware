...
0>e&&(e=0)||e>6&&(e=6),0>o&&(o=0)||o>1&&(o=1),0>t&&(t=0)||t>1&&(t=1),this.rgb=r(null===e?this.hsv[0]:this.hsv[0]=e,null===o?this.hsv[1]:this.hsv[1]=o,null===t?this.hsv[2]:this.hsv[2]=t),this.exportColor(s)},this.fromRGB=function(e,o,r,s){// null = don't change
0>e&&(e=0)||e>1&&(e=1),0>o&&(o=0)||o>1&&(o=1),0>r&&(r=0)||r>1&&(r=1);var i=t(null===e?this.rgb[0]:this.rgb[0]=e,null===o?this.rgb[1]:this.rgb[1]=o,null===r?this.rgb[2]:this.rgb[2]=r);null!==i[0]&&(this.hsv[0]=i[0]),0!==i[2]&&(this.hsv[1]=i[1]),this.hsv[2]=i[2],this.exportColor(s)},this.fromString=function(e,o){var t=e.match(/^\W*([0-9A-F]{3}([0-9A-F]{3})?)\W*$/i);// 6-char notation
// 3-char notation
return t?(6===t[1].length?this.fromRGB(parseInt(t[1].substr(0,2),16)/255,parseInt(t[1].substr(2,2),16)/255,parseInt(t[1].substr(4,2),16)/255,o):this.fromRGB(parseInt(t[1].charAt(0)+t[1].charAt(0),16)/255,parseInt(t[1].charAt(1)+t[1].charAt(1),16)/255,parseInt(t[1].charAt(2)+t[1].charAt(2),16)/255,o),!0):!1},this.toString=function(){return(256|Math.round(255*this.rgb[0])).toString(16).substr(1)+(256|Math.round(255*this.rgb[1])).toString(16).substr(1)+(256|Math.round(255*this.rgb[2])).toString(16).substr(1)};var m,g,f=this,b="hvs"===this.pickerMode.toLowerCase()?1:0,y=!1,k=jscolor.fetchElement(this.valueElement),j=jscolor.fetchElement(this.styleElement),v=!1,w=!1,E=1,x=2,C=4,M=8;
// valueElement
if(
// target
