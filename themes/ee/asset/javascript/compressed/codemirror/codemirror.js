...
if(pe(e),k(e,u),v(e,u),Ui&&e.options.lineWrapping&&M(e,u),s&&e.options.lineWrapping&&a!=e.display.scroller.clientWidth)r=!0;else if(r=!1,
// Clip forced viewport to actual scrollable area.
t&&null!=t.top&&(t={top:Math.min(u.docHeight-tl-u.clientHeight,t.top)}),
// Updated line heights might result in the drawn area not
// actually covering the viewport. Keep looping until it does.
l=m(e.display,e.doc,t),l.from>=e.display.viewFrom&&l.to<=e.display.viewTo)break}return e.display.updateLineNumbers=null,n&&(_n(e,"update",e),(e.display.viewFrom!=i||e.display.viewTo!=o)&&_n(e,"viewportChange",e,e.display.viewFrom,e.display.viewTo)),n}
...
Pi&&27==e.keyCode&&(e.returnValue=!1);var r=e.keyCode;t.display.shift=16==r||e.shiftKey;var n=Dt(t,e);Xi&&(yo=n?r:null,
// Opera has no cut event... we try to at least catch the key combo
!n&&88==r&&!xl&&(Ji?e.metaKey:e.ctrlKey)&&t.replaceSelection("",null,"cut")),
